...
public class Application{
    public static void main(String[] args){
        ...
        //the while loop allows the menu to repeat, so the user may continuosly add numbers
        while(true){
            ...
            if(choice.equals("add")){
                ...
                if(b){
                    ...
                    System.out.println("that number does not exists");
                }
 ...
 * Queues - kind of a line at store - first in, first out - eg a tech support channel
 * Stacks - kind of a like a stack of plates - last in, first out - eg undo/redo buttons(a stack of changes), or emails
 * 
